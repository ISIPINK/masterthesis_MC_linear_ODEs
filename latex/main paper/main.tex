...
This recursive integral equation can be turned into a RRVE by sampling $\tau \sim U$ treating the $2$ integrals as
$1$ and sampling $1$ of the $\tilde{u}$ of the second integral to avoid branching recursion. TODO: write down
estimator (have it in julia code).

\begin{julia}
    \juliacode{julia code/point_estimator_heat.jl}
\end{julia}

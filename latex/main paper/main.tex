...
some smoothness classes. Like our method, their approach also employs control variates. \\
...
to ours, is based on Volterra integral equations.
...
\begin{example}[Splitting on (\ref{eq:simple russian roulette})] \label{ex:simple splitting}
  ...
  $10$ times as often which is insignificant to evaluating $f(U)$ once

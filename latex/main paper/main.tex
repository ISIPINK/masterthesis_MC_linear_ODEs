...
\begin{itemize}
    ...
    \item  information complexity literature which was
          ...
          biased algorithms for ODEs that achieve optimal
...
\begin{theorem}[Information Curse of Dimensionality (Integration)]
    State the information curse of dimenstionality for integration for
    deterministic errors.
\end{theorem}

\begin{related}[Information Curse of Dimensionality (Integration)]

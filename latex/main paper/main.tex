...
\begin{related}[MC for linear systems]
    ...
    which should have similar behavior to the orginal problem. \\
...
\begin{itemize}
    \item An unbiased MC method for linear IVP ODEs of higher order with stability issues.
    \item Meager extension of recursive first passage sampling algorithm discussed in
          \cite{herrmann_first-passage_2016}.
    \item Coupled recursion and recursion in recursion reformulation of the coupling in
          \cite{vicini_path_2021} and next flight in  \cite{sawhney_grid-free_2022}.
\end{itemize}

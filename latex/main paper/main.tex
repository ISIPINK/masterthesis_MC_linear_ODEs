...
\begin{itemize}
    ...
    \item  Information-Based Complexity (IBC) literature which was
          ...
          IBC rates in the randomized case, similar to us
...
MC integration is an algorithm that
...
% need a reference to later
An other popular way to compare algorithms is Information-Based Complexity (IBC).
IBC is a way to describe asymptotically (for increasing accuracy/function calls)
the trade-off between the amount of function calls needed and accuracy.
...
% Base your answers on the thesis. Cite the subsections 
% you use in your answers your questions.
% corresponding to the questions.
% Add the questions before the answer, answer as a markdown file.
% Use subnumerings in numbering the question that works in a markdown file.
%
% # Content tests
...
% 1.6 What are the advantages of the solvers in the subsetion of intial value problems 
...
% 2.2 In the subsection of recursive Monte Carlo why is there indefinete 
% recursion?

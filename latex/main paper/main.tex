...
\begin{pythonn}[implementation of (\ref{MCtrap})]
    ...
    \begin{figure}[h!]
        ...
        \caption{Log-log plot of (\ref{MCtrap}).
...
convergence over the normal composite rule for every dimension
under the right smoothness conditions.
...
The examples of ODEs up to this point all suffer from exploding variance
with increasing the domain. (instability)

\begin{example}[coupled split]

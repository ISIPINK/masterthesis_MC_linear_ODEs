...
\begin{definition}[Brownian Motion]
    limit of how I program it
\end{definition}

\begin{definition}[first passage problem ] \label{def:first passage}
    explains what a first passage problem is for Brownian motion
    and a barrier
\end{definition}

\begin{example}[(\ref{def:first passage}) triangular barrier]

\end{example}

\begin{theorem}[scale invariance Brownian Motion]
    explains the scale invariance of Brownian Motion
\end{theorem}


\begin{example}[scaled (\ref{def:first passage}) triangular barrier]

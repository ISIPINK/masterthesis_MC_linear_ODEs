...
There are other things that could be further developed. The way control
variates are constructed, the type of control variates, adaptive schemes,
freezing less important terms in the recursion in recursion ...
the point is there is a lot of room for improvement. \\
...
unbiased estimates of $e^{A(t-s)} y(s)$ type of expressions. Initially, we came
...
All the communication that is needed is averaging the final estimator. We conjecture

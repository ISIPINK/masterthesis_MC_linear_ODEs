...
\textcolor{darkgreen}{
    We miss a subsection on stochastic gradient descent (SGD) and
    ...
    how we use recursion in recursion in the next section.
} \\
...
\textcolor{darkgreen}{
    We should add more metrics to plot for the examples.

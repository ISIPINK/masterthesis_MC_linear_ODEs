...
discussed in \cite{sawhney_grid-free_2022}. This recursive Monte Carlo method
...
\begin{related}[MC for IVPs ODEs]
    ...
    \begin{itemize}
        \item \cite{jentzen_random_2009} describes a random Euler scheme for
              weak smoothness conditions.

        \item \cite{daun_randomized_2011} describes an randomized algorithm that
        ...
        \item \cite{ermakov_monte_2019}, \cite{ermakov_monte_2021} study unbiased  methods
